...
class BookOdd:
    def __init__(self, market: Market, book_name: str, odds: int, timestamp: datetime, isBest: bool) -> None:
...
class Bet:
    def __init__(self, market: Market, bet_odds: int, fair_odds: int, timestamp: datetime) -> None:
        self.market: Market = market
        self.bet_odds: int = bet_odds
